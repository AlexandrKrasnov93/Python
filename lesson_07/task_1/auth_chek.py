...
class authCheck:
    ...
    def color_adress(self):
        ...
        color_Adress = self.driver.find_element(By.CSS_SELECTOR, "#address").value_of_css_property('background-color')
        return color_Adress
    ...
    def color_jobpos(self):
        color_Jobpos = self.driver.find_element(By.CSS_SELECTOR, "#job-position").value_of_css_property('background-color')
        return color_Jobpos
